...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<c:if test="${not empty updateOfferBean.updateList}">
	<h:dataTable border="1" value="#{updateOfferBean.updateList}" var="item" rowClasses="row1,row2">
			<h:column id="id1">
				<f:facet name="header">
			...
			<h:column id="id2">
				...
				<h:inputText value="#{item.offerDiscount}"></h:inputText>
			</h:column>
			<h:column id="id3">
				<f:facet name="header">
			...
			<h:column id="id5">
				...
				<h:inputText value="#{item.offerDetails}"></h:inputText>
			</h:column>
</h:dataTable>
<br>	
<h:commandButton styleClass="btn" value="#{lable.Update_Offers}" action="#{updateOfferBean.updateOfferDetails}" type="submit"></h:commandButton>
</c:if>
