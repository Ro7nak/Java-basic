...
<title>JCart - Recently Added Products</title>
...
<center>
		...
		<div id="page">
	<h3><h:outputText value="#{lable.Recently_Added_Products}"></h:outputText></h3><br>
<br>
		
	<h:dataTable border="1" value="#{recentlyAddedProductsBean.recentProducts}" var="item" rowClasses="row1,row2" rendered="#{not empty recentlyAddedProductsBean.recentProducts}">
			<h:column id="id1">
				<f:facet name="header">
...
<br><br>
	<h:outputText value="#{recentlyAddedProductsBean.message}" styleClass="errorMsg"></h:outputText><br>
	</div>
	</div>
</center>
