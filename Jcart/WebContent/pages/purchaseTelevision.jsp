...
<title>JCart - Purchase Television  </title>
...
<div id="page">
	<div class="purchaseLeftPanel">
		...
		<h:panelGrid styleClass="grid">
			<h:commandLink value="> #{lable.Television}" action="#{purchaseTVBean.purchaseTelevision}">
	...
	<div class="purchaseRightPanel">
		...
		<c:if test="${purchaseTVBean.productList ne null and param.showlist ne 'no'}">
		<span class="purchaseTitle">
		<h:outputText value="#{lable.Television}      -"></h:outputText>&nbsp;&nbsp;&nbsp;
		<h:outputText value="#{purchaseTVBean.subCategoryName}"></h:outputText>
		</span><br>
		<h:dataTable value="#{purchaseTVBean.productList}" var="item" binding="#{purchaseTVBean.selectedData}">
		<h:column id="column1">
		<f:facet name="header"></f:facet>
		<div class="contentDiv">
		<span class="leftSidePanel">
		<img src="../page-resources/products/tv.jpg" class="productImage">
		</span>
		...
		<h:panelGrid columns="2">
			<h:panelGrid columns="2">
				...
				<h:outputText value="#{item.pixelResolution}"></h:outputText>
				<h:outputText value="#{lable.Screen_Size} :" styleClass="label"></h:outputText>
				<h:outputText value="#{item.screenSize}"></h:outputText>
			</h:panelGrid>
			<h:panelGrid columns="2">
				<h:outputText value="#{lable.Speaker_Type} :" styleClass="label"></h:outputText>
				<h:outputText value="#{item.speakerType}"></h:outputText>
				<h:outputText value="#{lable.Dimension} :" styleClass="label"></h:outputText>
				<h:outputText value="#{item.dimension}"></h:outputText>
		...
		<c:if test="${empty purchaseTVBean.productList and param.showlist ne 'no'}">
		<center>
		<h:outputLabel value="#{purchaseTVBean.errorMessage}" styleClass="errorMsg"></h:outputLabel><br><br>
		</center>
		</c:if>
	</div>
