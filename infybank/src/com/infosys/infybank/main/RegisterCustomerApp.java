...
public class RegisterCustomerApp {
	...
	private void captureInput(Scanner sc) {
		...
		System.out.println("Do you want to make this account Salaried? Y/N :");
		String salr = sc.next();
		...
		try {
			...
			System.out.println(
					"****Customer Registered sucessfully! Your loginId and password details will be sent to your mail. ****");
